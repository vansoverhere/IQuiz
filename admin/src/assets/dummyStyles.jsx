...
export const navbarStyles = {
  // Navigation bar
  nav: "bg-white/90 font-serif backdrop-blur-lg border-b border-gray-100 sticky top-0 z-[9999] shadow-sm",  container: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8",
...
export const dashboardStyles = {
  ...
  // ----- Toast Notification -----
  toastOuter: "fixed top-6 right-4 z-10000 max-w-sm w-full transform transition-all duration-300",
...
export const listPageStyles = {
  ...
  // ----- Toast -----
  toastContainer: "fixed top-6 right-6 z-10000",
  toastOuter: "max-w-sm w-full pointer-events-auto transition-all transform origin-top-right",
  toastVisible:"opacity-100 translate-y-0 pointer-events-auto",
  toastHidden:"opacity-0 -translate-y-4 pointer-events-none",
